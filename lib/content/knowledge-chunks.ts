...
export const knowledgeChunks: KnowledgeChunk[] = [
  {
    id: "quota",
    text: "Matt maintained 100% median quota attainment over 5 years at Salesforce, compared to a <50% team average, and exceeded multi-year targets 3x with consecutive years above 200%.",
  },
  {
    id: "k12-market",
  ...
  },
  {
    ...
    text: "Beyond the K-12 Public District market, Matt created an entirely separate new market for Salesforce in education from zero: he hosted regular community events to convene an untapped sector, then partnered with an SI to build the specific capability missing from the Salesforce product stack that let the market actually be captured (the Student Information System later built for Christian Education Ministries came out of this same motion). That work opened up an estimated $25M+ untouched TAM (total addressable market) across the Australian East Coast, sized from the independent schools and Catholic diocesan systems across NSW, VIC, and QLD that had never been meaningfully worked before, using a conservative average deal size in line with what Matt actually landed and grew at Christian Education Ministries. Matt frames this deliberately as market creation, not just prospecting: the skill was building the events, the partner capability, and the category itself, not working harder against an existing list. He arrived at the $25M+ TAM number bottom-up: real deal economics he'd already proven, applied across the count of independent and diocesan schools in that untapped sector, not a top-down analyst estimate.",
  },
  {
    id: "christian-ed",
  ...
  },
  {
    ...
    text: "Matt worked directly with AWS on enterprise accounts, aligning cloud infrastructure modernization with institutional procurement and deployment timelines.",
  },
  {
  ...
  },
  {
    ...
    text: "At monō ai, Matt engineers Create AI prototypes to replace static architecture slides, demonstrating real-time application behavior, API orchestration, and workflow visibility directly to technical decision-makers, without leaning on a solutions engineer as a crutch.",
  },
  {
  ...
  {
    id: "referenceability",
    text: "Matt secured the first 3 Education Cloud enterprise customer implementations live across ANZ, establishing referenceability for the new K-12 market segment.",
  },
  {
    id: "prior-experience",
    text: "Before Salesforce, Matt was an Account Executive (Academic Advisor) at Crimson Education (Aug 2020 - Mar 2021), and before that spent 15 years in education leadership: Head of Positive Education and Head of Year at Knox Grammar School (2006-2019).",
  },
  {
    id: "education",
  ...
  },
  {
    ...
    text: "Matt's honest gap for this role is that he hasn't sold an observability or APM platform specifically before: Salesforce is a CRM and application platform, not a monitoring stack, so the product category itself is new ground. What isn't new ground, and what he leans on to close that gap, is that the core craft of enterprise sales is universal and product-agnostic: gathering information, deeply knowing the customer's business, multithreading across an org, building and maintaining a real champion, managing the process on both sides (internally and with the customer), presenting back a solution that proves you actually understand their business and needs, and ushering the deal through procurement to close. None of that depends on the product category, it's the same craft whether the product is a CRM platform or an observability platform, and it's what comes naturally to him. Combined with a genuine love of learning and a natural competitiveness, that's how he expects to close the product-category gap quickly and excel, not by pretending the gap doesn't exist.",
  },
  {
  ...
  {
    id: "twenty-years-in-education-credibility",
    text: "Matt has spent roughly 20 years connected to the education sector: 15 years as an educator himself in school leadership, then selling into education at Salesforce and now monō ai. He treats that firsthand experience as a genuine differentiator, not just a résumé line. Education has a very unique view of its own business, with its own specific talking points that an outside vendor doesn't naturally speak, even though at its core education is essentially a service business like any other. Knowing how to talk from firsthand experience, having actually sat inside the institution rather than only sold to it, is a key way to open more doors, bring down walls, and gain the trust required to build transformational deals in this sector.",
  },
  {
  ...
  {
    id: "how-i-learn-fast",
    text: "Asked how he learns fast, Matt points back to his start in tech sales: he had zero knowledge or experience in the industry to draw on. What he did have was the ability to learn fast, and the even more important skill underneath that, the ability to teach. Teaching forces you to both learn all the important information yourself and deeply consider how to present it in the most engaging, memorable way to a group of people who mostly don't want to be there. The result was that he consumed everything there was to know about Salesforce and its products, to the point where he became the go-to person on his team whenever anyone needed to learn the ever-expanding product line that core account executives had to sell. He genuinely enjoyed the challenge of mastering and selling each new product, and there were many of them, every single financial year.",
  },
];
